...
public class BOJ5430 {
    ...
    private static class Deque<E> {
        ...
        /**
         * Add new element to datastructure.deque
         * @param element A new element to insert into the datastructure.deque
         * @param isReversed
         */
        ...
        /**
         * Remove head element from datastructure.deque
         * @param isReversed
         * @return Head element of datastructure.deque
         */
        ...
        /**
         * Remove tail element from datastructure.deque
         * @return Head element of datastructure.deque
         */
        public E pollTail() {
            return poll(!this.isReversed);
        ...
        /**
         * Get the value of datastructure.deque without deleting it
         * @param isReversed
         * @return Head element of datastructure.deque
         */
         ...
         * @return Tail element of datastructure.deque
         */
        public E peekTail() {
            return peek(!this.isReversed);
        }
         ...
         * @return Index value of element (If the element does not exist in the datastructure.deque, return -1)
         */
        ...
        /**
         * reverse the datastructure.deque (slow method, O(N))
         */
        @Deprecated
        ...
        /**
         * reverse the datastructure.deque direction
         */
        public void reverse() {
        ...
        /**
         * If size of datastructure.deque is 0, return {@code true}. Else return {@code false}.
         * @return If size of datastructure.deque is 0, return {@code true}. Else return {@code false}.
         */
        ...
        /**
         * Return size of datastructure.deque
         * @return Size of datastructure.deque
         */
        public int size() {
            return size;
